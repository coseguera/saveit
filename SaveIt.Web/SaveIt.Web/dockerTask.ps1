...
.PARAMETER Clean
Removes the image saveit.web and kills all containers based on that image.
...
Build a Docker image named saveit.web
#>
...
$imageName="saveit.web"
$projectName="saveitweb"
$serviceName="saveit.web"
